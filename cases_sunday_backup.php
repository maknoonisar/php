  ...
  <div >
    ...
    <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/bag.webp" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:22px; font-weight:600; color:#ffffff; letter-spacing:6px;">SUSPICIOUS OBJECT DETECTION</h5>
              </div><!--card body end==--><!--card body==-->
              <!--       <div class="card-body">
                <p class="card-text" style="margin-top:-18px; margin-bottom:7px; font-size:18px; color:#c7c7c7; font-family:'Heebo', sans-serif;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div> --><!--card body end==--><!--card body==-->
          ...
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/fd.png" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:22px; font-weight:600; color:#ffffff; letter-spacing:6px;">ACCESS CONTROL SYSTEM</h5>
              </div><!--card body end==--><!--card body==-->
              <!-- <div class="card-body">
          ...
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/weapon.png" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:22px; font-weight:600; color:#ffffff; letter-spacing:6px;">WEAPON DETECTION SYSTEM</h5>
              </div><!--card body end==--><!--card body==-->
              <!--            <div class="card-body">
          ...
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/pedestrian_count.jpg" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:22px; font-weight:600; color:#ffffff; letter-spacing:6px;">PEDESTRIAN COUNTER</h5>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-1 columntop">
          <div class="box0">
            <a href="vehicle_detect.php" style="cursor:pointer; text-decoration:none;">
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/trafficanalysis.jpg" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:21px; font-weight:600; color:#ffffff; letter-spacing:4px;">INTELLIGENT TRANSPORTATION SYSTEM</h5>
              </div><!--card body end==--><!--card body==-->
              <!-- <div class="card-body">
                <p class="card-text" style="margin-top:-18px; margin-bottom:7px; font-size:18px; color:#c7c7c7; font-family:'Heebo', sans-serif;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div> --><!--card body end==--><!--card body==-->
          ...
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:10px;">
              <img src="images/VehicleDetection_2_600.jpg" class="card-img-top" alt="..."> <!--card body==-->
               <!--card body end==--><!--card body==-->
              <div class="card-body">
                <h5 class="card-title text-center" style="font-family:'Heebo', sans-serif; font-size:21px; font-weight:600; color:#ffffff; letter-spacing:4px;">AERIAL OBJECT DETECTION</h5>
                <h6 style="color: black;">.</h6>
              </div><!--card body end==--><!--card body==-->
              <!-- <div class="card-body">
                <p class="card-text" style="margin-top:-18px; margin-bottom:7px; font-size:18px; color:#c7c7c7; font-family:'Heebo', sans-serif;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
