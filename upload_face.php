...
<body style=" background:#BECADF;">
  ...
  <div class="container1">
    <h1  class="display-5 text-light text-center text- font-weight-bold lead bg-gradient-light text-white">Access Control System</h1>
 ...
 <!-- <nav class="navbar navbar-light bg-dark">
  <a class="navbar-brand" href="http://localhost/horizon/cases.php">
    ...
    <img src="images/logo.png" width="50" height="50" class="d-inline-block align-top" alt="">
      ...
      <h3 class=" text-light text-center font-weight-bold lead bg-gradient-light text-white" > Access Control System</h3>
...
<!--   -->
  ...
  <form id=1 action="backend-face.php" method="post" enctype="multipart/form-data" style="background:#FFFFFF;">
