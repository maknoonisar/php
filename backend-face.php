...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  ...
  <div class="container1">
    <h1  class="display-4 text-light text-center text- font-weight-bold lead bg-gradient-light text-white">Access Control System</h1>
     <hr class="my-4">
...
<!-- <form style="margin-left: 36%;" action="http://192.168.18.32/testing.php" method="post" id="bases"> -->
  <form style="margin-left: 36%;" action="http://localhost/horizon/runpy-face.php" method="post" id="bases" >
