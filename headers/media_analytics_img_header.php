	  ...
	  <li class="nav-item">
		...
		<div class="casesnavbr">
			...
			<li class="nav-item">
				...
				<a class="nav-link" href="#" style="margin-top:-62px; margin-left:105px; color:#ffffff !important; font-size:16px; word-spacing:4px;">MEDIA ANALYTICS</a>
			</li>
		</div>
	  
	  <li class="nav-item" style="position:absolute; right:30px;">
		<a class="nav-link add-vedio" data-bs-target="#reg" data-bs-toggle="modal">  
			<span class="fas fa-plus-circle" style="color:#258cd3; font-size:20px;"> </span> ADD IMAGE
		</a>
	  </li>
    </ul>
  </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				Select a file : <input type='file' name='file' accept="image/*" id='imgfile' class='form-control'><br>
