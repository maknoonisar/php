  ...
  <div class="col" style="margin-top:-8px; margin-bottom:1px;">
	<div class="navbar-header">
		<a class="navbar-logo" href="#">
				...
				SMART SURVEILLANCE AND SECURITY SYSTEM  
			</div>
		</a>
	</div>
   </div>
	  ...
	  <li class="nav-item">
		...
		<div class="casesnavbr">
			...
			<li class="nav-item">
				...
				<a class="nav-link" href="#" style="margin-top:-62px; margin-left:105px; color:#ffffff !important; font-size:16px;">INTELLIGENT TRANSPORTATION SYSTEM</a>
			</li>
		</div>
