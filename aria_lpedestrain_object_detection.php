...
<!-----head------->
<?php include "headers/arial_pedestrain_object_detect_head.php" ?>
<!--end head------>
...
<?php 
$local_dir = 'input_arial_pedestrain_object_detect_videos/';
...
<!------------------------------------------------->
		...
		<!--output of model Crime scene detection-->
			...
			<?php
				...
				$dir = __DIR__ . DIRECTORY_SEPARATOR . "output_arial_pedestrain_object_detect_videos" . DIRECTORY_SEPARATOR;
				$images = glob($dir . "*.{mp4,avi,webm}", GLOB_BRACE);
 
				// (C) OUTPUT VIDEO 
				foreach ($images as $i) {
				printf(" <center> <video width='1150' height='800' src='output_arial_pedestrain_object_detect_videos/%s'  controls autoplay muted/>  </center>", basename($i));
				}
			?>	
			</div>
		</div>
...
<!--column 3-->
	<div class="col-2 subbar scrollbar"  style="background-color:">
     	<ul style="padding: 0 0 0 0;">
				<li class='sub-menu'> <a class ="nav-link" href="#">Source</a> </li>
				<li class='sub-menu'> <a class ="nav-link"  href="#">Time Rang </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Class</a> </li>
				<li> <a class ="nav-link"  href="#"> Person Attributes</a> </li>
				<li> <a class ="nav-link" href="#"> Color </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Size </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Speed</a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Dwell </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Direction </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Appearance Similarity </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> Face Recognization </a> </li>
				<li class='sub-menu'> <a class ="nav-link" href="#"> License Plate Recognization</a> </li>
		</ul>
	</div>
<!--column 3 end-->	
 ...
 function fetch_month1(hh)
            {
	            ...
	            $.ajax({
				type: 'POST',
				url: 'file_product_arial_object.php',
				data: { name: hh },
...
<script type="text/javascript">
    document.getElementById("savechngved").onclick = function () {
        location.href = "crime_scene_detect.php";
    };
</script>
