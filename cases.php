      ...
      <div class="row">
        ...
        <div class="gx-5">
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:0px;">
        ...
        <div class="gx-5">
          <div class="box0">
            ...
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:2px;">
        ...
        <div class="gx-5">
          <div class="box0">
            <a href="videos_personid.php" style="cursor:pointer; text-decoration:none;">
            <div class="profile-card-1" style="width:18rem; border:2px solid #787878; border-radius:2px;">
