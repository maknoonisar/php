...
$files = glob('C:/xampp/htdocs/horizon/weapon_upload_files'.'/*'); // get all file names
...
<!-- <form style="margin-left: 36%;" action="http://192.168.18.32/testing.php" method="post" id="bases"> -->
  <form style="margin-left: 36%;" action="http://localhost/horizon/runpy-weapon.php" method="post" id="bases">
...
// echo $total;
$target_dir = "weapon_upload_files/";
for( $i=0 ; $i < $total ; $i++ ){
...
&& $imageFileType != "tif" && $imageFileType != "jp2" && $imageFileType != "mp4" && $imageFileType != "jp2" && $imageFileType != "avi") {
...
if ($uploadOk == 0) {
  ...
  window.location.replace("http://localhost/horizon/upload_weapon.php");
  </script>
  <a href="http://localhost/horizon/upload_weapon.php" style="margin-top:20%;"> 
    Upload Image Again  
     </a>';
...
<img src="images/loader.mp4" id="img" style="justify-content: center;"/ >
