...
$files = glob('C:/xampp/htdocs/horizon/input_video_action'.'/*'); // get all file names
...
<!-- <form style="margin-left: 36%;" action="http://192.168.18.32/testing.php" method="post" id="bases"> -->
  <form style="margin-left: 36%;" action="http://localhost/horizon/runpy-action.php" method="post" id="bases">
...
if ($uploadOk == 0) {
  ...
  window.location.replace("http://localhost/horizon/upload_action.php");
  </script>
  <a href="http://localhost/horizon/upload_action.php" style="margin-top:20%;"> 
    Upload Image Again  
     </a>';
