...
$files = glob('C:/xampp/htdocs/horizon/upload_target'.'/*'); // get all file names
...
<!---<nav class="navbar navbar-light bg-dark">
  ...
  <div class="container1">
    <h1  class="display-4 text-light text-center text- font-weight-bold lead bg-gradient-light text-white">Target Identification</h1>
     <hr class="my-4">
...
<!-- <form style="margin-left: 36%;" action="http://192.168.18.32/testing.php" method="post" id="bases"> -->
  <form style="margin-left: 36%;" action="http://localhost/horizon/runpy-target.php" method="post" id="bases">
