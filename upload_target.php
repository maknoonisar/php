...
<!--               <div class="card-body">
                <div class="alert alert-info">
                  <span>Browse or drop images to run a Facial detection scan</span>
                </div> -->
...
<!--                   <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
       ...
       <form id=1 action="backend-target.php" method="post" enctype="multipart/form-data" style="background:#FFFFFF;">
