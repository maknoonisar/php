...
<!-----head------->
<?php include "headers/speech_englis_text_head.php" ?>
<!--end head------>
...
<!------------------------------------------------->
		...
		<!--output of model speech to text-->
			<div class="crimeveddis" id="outputved" style="display:block; background-color:;">
				...
				<i class="fas fa-microphone-alt"  style="font-size:39px; color:#2651729c; margin-top:159px; margin-right:12px;">
				</i>Speech to Text </div>
				
				<center>
					<div class="content_audio" style="">
 ...
 function fetch_month1(hh)
            {
	            ...
	            $.ajax({
				type: 'POST',
				url: 'speech_english_text_product_file.php',
				data: { name: hh },
...
<script type="text/javascript">
    document.getElementById("savechngved").onclick = function () {
        location.href = "speech_english_text.php";
    };
</script>
